...
serve(async (req) => {
  ...
  try {
    ...
    // This example uses the Resend API - you'll need to add your API key as a secret
    ...
    const emailData = {
      ...
      html: `
        ...
        <p>${message}</p>
        <hr>
        <p><em>This message was sent from the Kirangi Dogs website contact form.</em></p>
      `
    }
